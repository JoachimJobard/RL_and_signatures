...
COMMON = {
    ...
    "wandb.group": "comparison_signature_mg_window_size_09_03",
    "wandb.mode": "online",
    "eval_data_dir": "outputs/comparison_signatures_MG_window_size_09_03",
    "agent.signature.window_size": "10, 15, 30",  
...
EXPERIMENTS = {
    1: {
        ...
        "overrides": {
            ...
            "wandb.name": "signature_delay_${env.environment_params.delay}_depth_${agent.signature.depth}_seed_${seed}_window_${agent.signature.window_size}",
            "eval_data_name": "signature_delay_${env.environment_params.delay}_depth_${agent.signature.depth}_seed_${seed}_window_${agent.signature.window_size}",
        },
    },
    # 2: {
    #     "name": "No Signatures",
    ...
    #         "agent.training.eval_interval": "20",
    #         "agent.noise.schedule": "constant",
    #         "wandb.name": "no_signature_delay_${env.environment_params.delay}_seed_${seed}_window_${agent.signature.window_size}",
    #         "eval_data_name": "no_signature_delay_${env.environment_params.delay}_seed_${seed}_window_${agent.signature.window_size}",
    #     },
    # },
    # 3: {
    ...
    #         "agent.training.eval_interval": "20",
    #         "agent.noise.schedule": "constant",
    #         "wandb.name": "augmented_state_delay_${env.environment_params.delay}_seed_${seed}_window_${agent.signature.window_size}",
    #         "eval_data_name": "augmented_state_delay_${env.environment_params.delay}_seed_${seed}_window_${agent.signature.window_size}",
    #     },
    # },
    4: {
        "name": "Value Gradient",
        "overrides": {
            ...
            "agent.signature.origin_augmentation": "true",
            "agent.algorithm.fix_initial_state": "true",
            "wandb.name": "vg_delay_${env.environment_params.delay}_depth_${agent.signature.depth}_seed_${seed}_window_${agent.signature.window_size}",
            "eval_data_name": "vg_delay_${env.environment_params.delay}_depth_${agent.signature.depth}_seed_${seed}_window_${agent.signature.window_size}",
        },
    },
    5: {
        ...
        "overrides": {
            ...
            "agent.training.eval_interval": "20",
            "agent.noise.schedule": "constant",
            "wandb.name": "whole_state_delay_${env.environment_params.delay}_seed_${seed}_window_${agent.signature.window_size}",
            "eval_data_name": "whole_state_delay_${env.environment_params.delay}_seed_${seed}_window_${agent.signature.window_size}",
        },
    },
}
...
def build_cmd(overrides: dict, seeds: str, delays: str = "30") -> list[str]:
    ...
    all_overrides["env.environment_params.delay"] = delays
