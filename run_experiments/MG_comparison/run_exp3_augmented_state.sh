#!/bin/bash
# =============================================================================
# Experiment 3: Augmented State (CTAC with delayed state concatenation)
# =============================================================================
...
echo "=============================================="
echo "Experiment 3: Augmented State (delayed)"
echo "=============================================="
...
do
    echo ">>> [Exp3 - Seed $SEED] CTAC with augmented state"
    ...
    uv run python main_unified.py -m \
        ...
        eval_data_name="augmented_state_seed_${SEED}"
done

echo "Experiment 3 complete for seeds $START_SEED to $END_SEED"
