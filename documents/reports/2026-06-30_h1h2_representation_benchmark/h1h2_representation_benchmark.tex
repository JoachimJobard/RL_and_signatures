...
\multirow{3}{*}{chaotic}
 ...
 & 4 & \multicolumn{3}{c}{\footnotesize(in progress)}\\
\bottomrule
\end{tabular}
\end{minipage}
\end{table}
...
($I_H=0.0143$ versus $0.0184$, $\gamma_H=0.87$). Its off/dim${}=4$ point, requiring
$\sim10^{4}$ Pontryagin solves, was still computing at the time of writing and is left blank.
\end{finding}
...
variance); the canonical $H_1/H_2$ table is five-seed. The mg\_chaotic off/dim${}\in\{2,4\}$
points (Table~\ref{tab:generality}), each requiring $5$--$10\times10^{3}$ Pontryagin solves, were
still computing at the time of writing and are marked as such rather than filled. The trajectory
