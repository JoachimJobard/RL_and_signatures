...
Emits a tidy CSV: time, no_control, oracle, markovian, raw_history, signature -- the six illustrative
curves of Figure 1 (target is the constant 0). The TikZ figure in the paper is rebuilt from this CSV.
